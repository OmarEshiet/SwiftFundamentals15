...
func track(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    if currentTime > goalTime/2 {
        print("Keep it up!")
    }
    else {
...
track(currentDistance: 5, totalDistance: 12, currentTime: 8, goalTime: 30)
