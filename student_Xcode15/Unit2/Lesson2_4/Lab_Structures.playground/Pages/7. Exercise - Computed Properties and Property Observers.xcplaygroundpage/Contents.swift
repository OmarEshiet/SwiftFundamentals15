...
let shape = Rectangle(width: 10, height: 2)
print(shape.area)
/*:
...
var someHeight = Height(heightInInches: 49)
print(someHeight.heightInCentimeters)


var otherHeight = Height(heightInCentimeters: 700)
print(otherHeight.heightInInches)
