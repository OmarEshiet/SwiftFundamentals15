...
var favoriteBook = Book(title: "Nihilism and technology", author: "Nolan Gertz", pages: 242, price: 38.00)
...
let oneLaptop = Laptop(yearPurchased: 2001)
let twoLaptop = Laptop(yearPurchased: 1987)
/*:
...
var examp = Height(inches: 65)
print(examp.heightInInches)
print(examp.heightInCentimeters)
...
var myHeight = Height(inches: 74.0) // inches
