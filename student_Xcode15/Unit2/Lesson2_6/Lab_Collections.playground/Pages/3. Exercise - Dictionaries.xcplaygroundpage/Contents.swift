...
if let janDays = daysInMonth["January"] {
    print("January has ", daysInMonth["January"]! ," days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
let shapesArray = ["Rectangle", "Oval", "Triangle"]
let colorsArray = ["Yellow", "Blue", "Red"]
let both: [String:[String]] = ["Shapes":shapesArray, "Colors": colorsArray]
print(both)
