 ...
 */
let walking = ["Walk 10 miles per day", "Walk dog for at least 1 hour"]
let running = ["Run on the side of the highway, daily", "Chase the mailman"]
let eating = ["Eat under 800 calories per day", "Dont eat any green vegetables"]
...
var challenges = [walking, running, eating]
...
var commit: [String] = ["Eat 4 bowls of cereal" ," Dont drink water"]

//:  Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
if commit.isEmpty {
    print("Commit to a challenge, or else!")
    
} else if commit.count == 1 {
    print("The challege you have chosen is", commit[0])
} else {
    print("You have chosen multiple challenges, ", commit)
}
