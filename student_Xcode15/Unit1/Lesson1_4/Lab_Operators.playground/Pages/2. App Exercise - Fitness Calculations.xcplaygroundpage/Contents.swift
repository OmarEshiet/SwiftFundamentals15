...
let heartRate2D : Double = 69
let heartRate3D : Double = 92
let addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
print(averageHRD)
print("When every number is a double there is now an added decimal point ni==instead of the output rounding down")
...
let percentOfGoal = (steps / goal) * 100 // equation to get percent of 10000
 print(percentOfGoal)
/*:
