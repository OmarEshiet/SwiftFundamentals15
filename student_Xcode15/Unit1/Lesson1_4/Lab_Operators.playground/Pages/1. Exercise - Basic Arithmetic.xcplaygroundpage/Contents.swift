...
//It appears to not change at all, unless I were to place a ".00" on the end the output still rounds down to 3
...
print(even%2)
print(odd%2)
// When you use the modulus operatpr to check if a number is even or odd depending on if the remandr is even or odd 
// odd numbers will have a remander that is odd
